  ...
  <main class="modern-home">
    <section class="hero-section">
      <div class="page-container hero-content">
        ...
        <h1>Sugargoo Spreadsheet <span>2026</span></h1>
        <p class="hero-copy">
          Discover organized Sugargoo finds across clothing, shoes, pants, hats, accessories and electronics,
        ...
        <div class="hero-actions">
          <div class="cta-preview-wrap cta-preview-spreadsheet">
            <div class="cta-preview-card" aria-hidden="true">
              <img src="/images/sugargoo-spreadsheet-preview.png" alt="Sugargoo Spreadsheet preview showing curated product categories and shopping links" title="Sugargoo Spreadsheet preview" />
          ...
          <div class="cta-preview-wrap cta-preview-shopping">
            <div class="cta-preview-card" aria-hidden="true">
              <img src="/images/sugargoo-shopping-preview.png" alt="Sugargoo shopping preview showing product categories and item options" title="Sugargoo shopping preview" />
    ...
    <section id="essential-guides" class="section section-muted essential-guides">
      <div class="page-container">
        <div class="section-heading section-heading-left guides-heading">
          ...
          <p>New to Sugargoo? These short guides explain how the platform works, what the spreadsheet is for and how to begin with a clearer plan.</p>
        </div>
    ...
    <section id="community-research" class="section section-research">
      <div class="page-container research-card">
        <div>
          <p class="section-kicker">Consolidated shipping</p>
          <h2>Plan multi-platform discovery and parcel consolidation.</h2>
          <p class="research-card-copy">Compare marketplace coverage, QC and rehearsal questions, packaging, consolidated parcels and live shipping-line quotes instead of treating one testimonial as a universal result.</p>
          <a href="/blog/sugargoo-community-buying-guide/" class="research-card-link">Read the Sugargoo research guide <span aria-hidden="true">→</span></a>
        </div>
        <div class="research-card-note">
          <strong>Sugargoo community research</strong>
...
const guideCards = [
  {
    ...
    title: 'How to Buy with Sugargoo',
  ...
  },
  {
    ...
    title: 'What Is the Sugargoo Spreadsheet?',
  ...
  {
    label: 'Why it helps',
    title: 'Key Benefits of Sugargoo',
